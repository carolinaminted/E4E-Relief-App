  ...
  return (
    <div className="p-8 max-w-2xl mx-auto text-center flex flex-col items-center justify-center h-full">
      <div className="bg-slate-800 p-10 rounded-lg shadow-lg">
        ...
        <h1 className="text-3xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-blue-400">
          Submission Successful!
        </h1>
        <p className="text-slate-300 mb-2">Your application for relief has been received.</p>
        <div className="bg-slate-700 rounded-md px-4 py-2 my-6 inline-block">
          <p className="text-slate-400 text-sm">Your Application ID is:</p>
