  ...
  return (
    ...
    >
      ...
      >
        <button 
          onClick={onClose}
          className="absolute top-4 right-4 text-[#898c8d] hover:text-white"
        ...
        <div className="space-y-4 text-gray-300">
          <div className="flex justify-between border-b border-[#002a50] pb-2">
            <span className="font-semibold text-[#898c8d]">Application ID:</span>
            <span className="font-mono">{application.id}</span>
          </div>
          <div className="flex justify-between border-b border-[#002a50] pb-2 items-center">
            <span className="font-semibold text-[#898c8d]">Status:</span>
            <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${statusStyles[application.status]}`}>
                {application.status}
            </span>
          </div>
          <div className="flex justify-between border-b border-[#002a50] pb-2">
            <span className="font-semibold text-[#898c8d]">Submitted Date:</span>
            <span>{application.submittedDate}</span>
          </div>
          <div className="flex justify-between border-b border-[#002a50] pb-2">
            <span className="font-semibold text-[#898c8d]">Hire Date:</span>
            <span>{application.hireDate}</span>
          </div>
          <div className="flex justify-between border-b border-[#002a50] pb-2">
            <span className="font-semibold text-[#898c8d]">Event Type:</span>
            <span>{application.event}</span>
          </div>
          <div className="flex justify-between">
            <span className="font-semibold text-[#898c8d]">Requested Amount:</span>
